...
<html>
	...
	<body>
		...
		<form method="post" action="reset.php">
			<p>
				<label for="email" id="label" >邮 箱<br/></label>
				<input class="text" id="text1" name="email" placeholder="请输入注册时的邮箱" type="text" value="" />
			</p>			
			<input class="button1" type="submit" name="" value="重设密码" />
		</form>
		</div>
	</body>
</html>