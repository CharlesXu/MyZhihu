...
<body>
		<div class="regist">
				<a href="register.php" class="register"><input class="button1" type="button" value="申请注册账号"/></a>  
		</div>
		<div id="login" style="float:left" >
			...
			<form class="login" action="index.php" method="POST" >				
				<input class="text" type="email" name="email" spellcheck="false" placeholder="邮 箱 或 用 户 名" autofocus tabindex="1">
				<input class="text" type="password" name="password" placeholder="密 码" tabindex="2">
				<input class="button" type="submit" name="sub" value="登 陆" tabindex="3"/>
				<div class="actions">
